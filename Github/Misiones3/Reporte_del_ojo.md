...
import math
```
## Constante de rotación y modo de luz
```
rotation = 0.0
light_mode = 0  # 0=Básica, 1=Múltiple, 2=Direccional, 3=Spotlight, 4=Colores
```
## Método para dibujar las esferas en forma de ojo
```
def draw_two_spheres():
    ...
    glPopMatrix()
```
## Configuracion de iluminación básica 
```
...
```
## Configuracion de iluminación multiple
```
...
```
## Configuracion de iluminación direccional
```
...
```
## Configuracion de la posición de la iluminación
```
...
```
## Configuracion de los colores de la luz
```
...
```
## Configuracion de modos de iluminción
```
def setup_lighting():
...
```
## Configuracion de los indicacores de iluminación
```
def draw_light_indicators():
    ...
    glEnable(GL_LIGHTING)
```
## Configuración para el cambio de modo de iluminación
```
