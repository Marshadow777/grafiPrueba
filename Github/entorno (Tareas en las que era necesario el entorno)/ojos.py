...
rotation = 0.0
eye_mode = 0  # 0=uno, 1=dos, 2=cuadrícula, 3=círculo, 4=triángulo
...
def draw_flower_eyes():
    kjds

def draw_triangle_eyes():
    """Triángulo de ojos"""
    ...
    posiciones = [
        ...
        (1, 0.25),
        (0, -1.5),
        (-2.0, -1.5),  # Ojo abajo izquierda
        (2.0, -1.5)    # Ojo abajo derecha
    ]
