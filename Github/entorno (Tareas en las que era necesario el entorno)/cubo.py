...
def draw_cube(x,y,z, pos):
    ...
    glLoadIdentity()
    glTranslatef(pos, 0.1, -15)  # Alejar el cubo para que sea visible *math.sin(angle)
    glRotatef(angle, x, y, z)   # Rotar el cubo en todos los ejes
...
def init():
    ...
    glMatrixMode(GL_PROJECTION)
    glLoadIdentity()
    gluPerspective(45, 0.0, 0.1, 50.0)
    # Cambiar a la matriz de modelo para los objetos
    glMatrixMode(GL_MODELVIEW)
